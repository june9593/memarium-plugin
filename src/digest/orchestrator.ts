...
//   1. ensureSpoolDir() — make sure raw_sessions/ exists
...
//
// The actual digest (typed-memory writing) is NOT done here — that stays in
// the skill, where in-session Claude has the full conversation context and can
// write naturally. This file is "warmup only".
